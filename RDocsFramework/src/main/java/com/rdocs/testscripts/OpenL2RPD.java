...
public class OpenL2RPD extends BrowserActions
{
	WebDriver driver;
	public OpenL2RPD(WebDriver driver) 
	{
		super(driver); 
		this.driver = driver;
	}
	...
	public void execution() throws Exception
	{
		...
		Thread.sleep(3000);
	    enterText(OutlookMailLocators.SearchBox, TrackReaders.MSG);	//To search level-2 RPD
		Thread.sleep(2000);
