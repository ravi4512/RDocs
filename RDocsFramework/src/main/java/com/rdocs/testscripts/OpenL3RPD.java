...
public class OpenL3RPD extends BrowserActions
{
	WebDriver driver;
	public OpenL3RPD(WebDriver driver) 
	{
		super(driver); 
		this.driver = driver;
	}
	...
	public void execution() throws Exception
	{
		...
		Thread.sleep(5000);
	    enterText(OutlookMailLocators.SearchBox, LimitReaders.MSG);		//To search level-3 RPD
		Thread.sleep(2000);
